...
- **FR5 (Asset Synthesis):** The `FloodPulseStudio` orchestrator synthesizes mission-specific maps upon persona request using Gemini 2.5/3.5 Flash.
...
- **FR10 (Idempotency):** Check-before-create logic ensures cost-efficient Gemini 2.5/3.5 utilization.
